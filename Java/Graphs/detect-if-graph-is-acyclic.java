...
//		return true;
	...
	public static void main(String[] args) {
		Graph_Cycle g = new Graph_Cycle(7);
		g.addEdge(1, 2);
		g.addEdge(2, 3);
		g.addEdge(3, 4);
		g.addEdge(1, 4);
		g.addEdge(6, 5);
		g.addEdge(5, 2);
		String res = g.solve() ? "no" : "yes";
		System.out.println(res); // no
	
		Graph_Cycle g2 = new Graph_Cycle(4);
		g2.addEdge(1, 2);
		g2.addEdge(4, 3);
		g2.addEdge(2,3);
		String res2 = g2.solve() ? "no" : "yes";
		System.out.println(res2); // yes
	}
