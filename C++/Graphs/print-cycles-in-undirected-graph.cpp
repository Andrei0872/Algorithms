...
/**
 * 
 * Given an undirected graph, print all cycles with length "p"
 * 
 * Example : {
 * V = 5, E = 6
 * 1 2
...
class Graph {
    ...
    int *dist;
    public:
        Graph(int _V, int _E, int _limit) {
            this->V = _V;
            this->E = _E;
            this->limit = _limit;
        ...
        ~Graph() {delete [] adj,par,parent,visited,tree;}
...
void Graph::bfs(int source, int &limit) {
...
int main () {
    ...
    // int V, E,v,w;
    // cin >> V >> E;
    Graph::testCase(); // 1 4 2 1, 4 5 3 4
}
